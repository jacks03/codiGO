...
const mascotas = [
  ...
  const filterCursostec = (arrayCursos, tefiltro) => {
      arreglos.filter((curso) => curso.tec === tecfiltro)
  }

  const cursosjs =filterCursostec(arregloCursos, "js")
  const cursosdjango =filterCursostec(arregloCursos, "django")
  const cursosangular =filterCursostec(arregloCursos, "angular")

  console.log("cursos js", cursosjs);
  console.log("curso django", cursosdjango);
  console.log("curso angular", cursosangular);
